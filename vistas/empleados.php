    ...
    <div class="container my-5">
        <div class="card shadow">
            <div class="card-header">
                ...
                <button class="btn btn-outline-success" style="float: right;" data-bs-toggle="modal" data-bs-target="#modalEmpleadosAdd">Agregar</button>
            </div>
            <div class="card-body">
                    ...
                    <table class="table table-striped table-hover">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" style="background-color: #1A5276 !important; color:aliceblue">Nombre(s)</th>
                                <th scope="col" style="background-color: #1A5276 !important; color:aliceblue">Correo</th>
                                <th scope="col" style="background-color: #1A5276 !important; color:aliceblue">Telefono</th>
                                <th scope="col" style="background-color: #1A5276 !important; color:aliceblue">Direccion</th>
