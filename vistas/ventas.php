...
<body class="bg-info-subtle">
    ...
    <?php include_once './modales/detalle_ventas.php'; ?>
                    ...
                    <table class="table table-striped table-hover">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" style="background-color: #1A5276 !important; color:aliceblue">Cliente</th>
                                <th scope="col" style="background-color: #1A5276 !important; color:aliceblue">Empleado</th>
                                <th scope="col" style="background-color: #1A5276 !important; color:aliceblue">Fecha Venta</th>
    ...
    <script src="../js/detalle_de_venta.js"></script>
</body>
